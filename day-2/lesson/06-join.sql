...
CREATE TABLE review (
    ...
    book_id BIGINT NOT NULL REFERENCES book(book_id), -- REFERENCES enforces "referential integrity"
...
-- written any books...
INSERT INTO book (title, publish_date, price) VALUES ('Pretty People Partying' , '2007-07-7', 7.99);
